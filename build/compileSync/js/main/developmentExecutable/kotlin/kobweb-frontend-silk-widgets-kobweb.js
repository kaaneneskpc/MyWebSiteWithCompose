(function (root, factory) {
  ...
  var Companion_getInstance_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.l2;
  var listStyle = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.j1;
  var Companion_getInstance_1 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.o2;
  ...
  var Companion_getInstance_3 = kotlin_com_varabyte_kobweb_silk_foundation.$_$.q1;
  ...
  var Img$composable = kotlin_org_jetbrains_compose_html_html_core.$_$.b5;
  ...
  var Companion_getInstance_7 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.m2;
  var objectFit = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.p1;
  var registerRefScope$composable = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.x1;
  ...
  var textDecorationLine = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.h2;
  var color = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.v;
  var get_ColorVar = kotlin_com_varabyte_kobweb_silk_widgets.$_$.g;
  var registerRefScope$composable_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.w1;
  ...
  function Link$composable(path, modifier, variant, openInternalLinksStrategy, openExternalLinksStrategy, autoPrefix, ref, content, $composer, $changed, $default) {
    _init_properties_Link_kt__dm1ox2();
    var modifier_0 = {_v: modifier};
    var variant_0 = {_v: variant};
    ...
    if (!(($dirty & 23967451) === 4793490) ? true : !$composer_0.get_skipping_3owdve_k$()) {
      ...
      var dispatchReceiver = composableLambda(tmp_3, 2134514244, true, Link$composable$lambda(ref_0, content));
      // Inline function 'androidx.compose.runtime.remember$composable' call
      var $composer_1 = $composer_0;
      $composer_1.startReplaceableGroup_ip860b_k$(-838505973);
      sourceInformation($composer_1, 'CC(remember$composable)P(1):Composables.kt#9igjgp');
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(Link$composable$lambda_0(path, modifier_0, variant_0, openInternalLinksStrategy_0, openExternalLinksStrategy_0, autoPrefix_0, ref_0, content, $changed, $default));
    }
  }
  ...
  function Link$composable$lambda($ref, $content) {
  ...
  function Link$composable$lambda_0($path, $modifier, $variant, $openInternalLinksStrategy, $openExternalLinksStrategy, $autoPrefix, $ref, $content, $$changed, $$default) {
    return function ($composer, $force) {
      Link$composable($path, $modifier._v, $variant._v, $openInternalLinksStrategy._v, $openExternalLinksStrategy._v, $autoPrefix._v, $ref._v, $content, $composer, updateChangedFlags($$changed | 1), $$default);
      return Unit_getInstance();
    };
  }
