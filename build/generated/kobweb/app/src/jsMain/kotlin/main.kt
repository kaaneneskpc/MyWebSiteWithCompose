...
public fun main() {
    ...
    com.varabyte.kobweb.core.init.initKobweb(router) { ctx ->
        ctx.router.register("/") { com.example.mywebsite.pages.HomePage() }
    ...
    com.varabyte.kobweb.silk.init.additionalSilkInitialization = { ctx ->
        ...
        ctx.theme.registerComponentStyle(com.example.mywebsite.styles.ButtonStyle)
        ctx.theme.registerComponentStyle(com.example.mywebsite.styles.SocialIconStyle)
        ctx.theme.registerComponentStyle(com.example.mywebsite.styles.ThemeIconStyle)
        com.example.mywebsite.overrideSilkTheme(ctx)
    }
    ...
    AppGlobals.initialize(mapOf("title" to "MyWebsite"))
    renderComposable(rootElementId = "root") {
        com.example.mywebsite.MyApp {
