...
import com.example.mywebsite.util.Res
import com.example.mywebsite.util.Res.Dimens.BORDER_RADIUS
...
enum class SocialIcon(
    ...
    Github(
        ...
        link = "https://github.com/kaaneneskpc"
    ),
    GithubLight(
    ...
    Instagram(
        ...
        link = "https://www.instagram.com/kaaneneskpc"
    ),
    InstagramLight(
    ...
    link = "https://www.linkedin.com/in/kaaneneskpc/"
    ),
    LinkedinLight(
